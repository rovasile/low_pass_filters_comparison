...
function [outputArg1] = desenare(M,wcGasit,fereastraGasita,wp,ws,cerinta_delta_p,cerinta_delta_s)
wc=wcGasit/pi;
r=85; %80-100 
beta=2;  %0-10
alfa=35; %0-100
...
switch fereastraGasita
 ...
 [H,om]=freqz(h);
    ...
    yline(1+cerinta_delta_p,'--k',{'delta_p'});
    str = sprintf('M=%d, WIN=%s, W_c=%0.2f%s', M,fereastraGasita, wcGasit/pi,'\pi');
    title(str);
end
